...
const AddCustomer = ({ refetch, setModal }) => {
        ...
        <div className="modal-box relative">
          ...
          >
            <input
              ...
              className="input w-full  input-bordered border-gray-400  font-semibold"
              required
            />
            ...
            <input
              ...
              className="input w-full input-bordered border-gray-400 font-semibold lowercase"
              required
            />
