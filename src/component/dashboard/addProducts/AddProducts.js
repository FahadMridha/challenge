...
const AddProducts = () => {
    ...
    fetch(url, {
      ...
      .then((imgData) => {
        if (imgData.success) {
          ...
          fetch(`https://e-commerce-server-three.vercel.app/addProduct`, {
            method: "POST",
            headers: {
  ...
  return (
    <div className="md:w-96 mx-auto my-12">
      <h2 className="text-3xl text-center text-orange-500  font-semibold ml-8 mb-4">
        Add A Product
      </h2>
      <div className="p-7 rounded-lg shadow-xl mx-2">
        <form onSubmit={handleSubmit(handleAddDoctor)}>
          ...
          <input
            className="mt-4 btn btn-success text-white w-full max-w-xs"
            type="submit"
            value="Add A Product"
          />
          <div></div>
